 ...
 *
 * Shared wrapper for all auth pages (login, signup, forgot, reset, verify).
 * Renders the decorative gradient background and centres the card.
 * Uses <Outlet /> so React Router v6 can render the matched child page.
 */
